...
focuspoint_slice([X,Y,W,H],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],N):-
	...
	focuspoint_slice2(topleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],NewIPs_left,NewIPs_right,N).
...
focuspoint_slice([X,Y,W,H],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],N):-
	...
	focuspoint_slice2(topright,[X,Y,X1,Y1],[W1,W2,H1,H2],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],NewIPs_left,NewIPs_right,N).
...
focuspoint_slice([X,Y,W,H],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],N):-
	...
	focuspoint_slice2(bottomright,[X,Y,X1,Y1],[W1,W2,H1,H2],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],NewIPs_left,NewIPs_right,N).
...
focuspoint_slice([X,Y,W,H],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],N):-
	...
	focuspoint_slice2(bottomleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[[FPX,FPY],[CP1X,CP1Y],[CP2X,CP2Y]],NewIPs_left,NewIPs_right,N).

 % focuspoint_slice2

focuspoint_slice2(_,_,_,_,[none],[none],_). 
...
focuspoint_slice2(topleft,[X,Y,X1,_],[W1,W2,H1,_],[FP,CP1,CP2],[none],[vert,IP1],N):-
	% writeln('topleft,none,vert'),
	slice([X,Y,W1,H1],[FP,CP1,IP1],N),
	slice([X1,Y,W2,H1],[IP1,CP2],N).

focuspoint_slice2(topleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[none],[vert_first,IP1,IP2],N):-
	% writeln('topleft,none,vert_first'),
	slice([X,Y,W1,H1],[FP,CP1,IP1],N),
	slice([X1,Y,W2,H1],[IP1,IP2],N),
	slice([X1,Y1,W2,H2],[IP2,CP2],N).

focuspoint_slice2(topleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[none],[horiz_first,IP1,IP2],N):-
	% writeln('topleft,none,horiz_first'),
	slice([X,Y,W1,H1],[FP,CP1,IP1],N),
	slice([X,Y1,W1,H2],[IP1,IP2],N),
	slice([X1,Y1,W2,H2],[IP2,CP2],N).

focuspoint_slice2(topleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz,IP1],[vert,IP2],N):-
	% writeln('topleft,horiz,vert'),
	slice([X,Y,W1,H1],[FP,IP1,IP2],N),
	slice([X1,Y,W2,H1],[IP2,CP2],N),
	slice([X,Y1,W1,H2],[CP1,IP1],N).

focuspoint_slice2(topleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz,IP1],[vert_first,IP2,IP3],N):-
...
focuspoint_slice2(topleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz,IP1],[horiz_first,IP2,IP3],N):-
...
focuspoint_slice2(topright,[X,Y,X1,_],[W1,W2,H1,_],[FP,CP1,CP2],[vert,IP1],[none],N):-
	% writeln('topright,vert,none'),
	slice([X,Y,W1,H1],[CP1,IP1],N),
	slice([X1,Y,W2,H1],[FP,IP1,CP2],N).

focuspoint_slice2(topright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[vert_first,IP1,IP2],[none],N):-
	% writeln('topright,vert_first,none'),
	slice([X,Y,W1,H1],[IP2,IP1],N),
	slice([X1,Y,W2,H1],[FP,IP2,CP2],N),
	slice([X,Y1,W1,H2],[CP1,IP2],N).

focuspoint_slice2(topright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz_first,IP1,IP2],[none],N):-
	% writeln('topright,horiz_first,none'),
	slice([X1,Y,W2,H1],[FP,IP2,CP2],N),
	slice([X1,Y1,W2,H2],[IP1,IP2],N),
	slice([X,Y1,W1,H2],[CP1,IP1],N).
	
focuspoint_slice2(topright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[vert,IP1],[horiz,IP2],N):-
	% writeln('topright,vert,horiz'),
	slice([X,Y,W1,H1],[CP1,IP1],N),
	slice([X1,Y,W2,H1],[FP,IP1,IP2],N),
	slice([X1,Y1,W2,H2],[IP2,CP2],N).

focuspoint_slice2(topright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[vert_first,IP1,IP2],[horiz,IP3],N):-
...
focuspoint_slice2(topright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz_first,IP1,IP2],[horiz,IP3],N):-
...
focuspoint_slice2(bottomright,[X,_,X1,Y1],[W1,W2,_,H2],[FP,CP1,CP2],[vert,IP1],[none],N):-
	% writeln('bottomright,vert,none'),
	slice([X1,Y1,W2,H2],[FP,IP1,CP2],N),
	slice([X,Y1,W1,H2],[CP1,IP1],N).

focuspoint_slice2(bottomright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[vert_first,IP1,IP2],[none],N):-
	% writeln('bottomright,vert_first,none'),
	slice([X,Y,W1,H1],[CP1,IP2],N),
	slice([X1,Y1,W2,H2],[FP,IP1,CP2],N),
	slice([X,Y1,W1,H2],[IP1,IP2],N).

focuspoint_slice2(bottomright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz_first,IP1,IP2],[none],N):-
	% writeln('bottomright,horiz_first,none'),
	slice([X,Y,W1,H1],[CP1,IP2],N),
	slice([X1,Y,W2,H1],[IP2,IP1],N),
	slice([X1,Y1,W2,H2],[FP,IP1,CP2],N).

focuspoint_slice2(bottomright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[vert,IP1],[horiz,IP2],N):-
	% writeln('bottomright,vert,horiz'),
	slice([X1,Y,W2,H1],[IP2,CP2],N),
	slice([X1,Y1,W2,H2],[FP,IP1,IP2],N),
	slice([X,Y1,W1,H1],[CP1,IP1],N).

focuspoint_slice2(bottomright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[vert_first,IP1,IP2],[horiz,IP3],N):-
...
focuspoint_slice2(bottomright,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz_first,IP1,IP2],[horiz,IP3],N):-
...
focuspoint_slice2(bottomleft,[X,Y,_,Y1],[W1,_,H1,H2],[FP,CP1,CP2],[horiz,IP1],[none],N):- % more cases like this?
	slice([X,Y,W1,H1],[CP1,IP1],N),
	slice([X,Y1,W1,H2],[FP,IP1,CP2],N).

focuspoint_slice2(bottomleft,[X,_,X1,Y1],[W1,W2,_,H2],[FP,CP1,CP2],[none],[vert,IP1],N):-
	% writeln('bottomleft,none,vert'),
	slice([X1,Y1,W2,H2],[IP1,CP2],N),
	slice([X,Y1,W1,H2],[FP,CP1,IP1],N).

focuspoint_slice2(bottomleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[none],[vert_first,IP1,IP2],N):-
	% writeln('bottomleft,none,vert_first'),
	slice([X1,Y,W2,H1],[IP2,CP2],N),
	slice([X1,Y1,W2,H2],[IP1,IP2],N),
	slice([X,Y1,W1,H2],[FP,CP1,IP1],N).

focuspoint_slice2(bottomleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[none],[horiz_first,IP1,IP2],N):-
	% writeln('bottomleft,none,horiz_first'),
	slice([X,Y,W1,H1],[IP1,IP2],N),
	slice([X1,Y,W2,H1],[IP2,CP2],N),
	slice([X,Y1,W1,H2],[FP,CP1,IP1],N).

focuspoint_slice2(bottomleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz,IP1],[vert,IP2],N):-
	% writeln('bottomleft,horiz,vert'),
	slice([X,Y,W1,H1],[CP1,IP1],N),
	slice([X1,Y1,W2,H2],[IP2,CP2],N),
	slice([X,Y1,W1,H2],[FP,IP1,IP2],N).

focuspoint_slice2(bottomleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz,IP1],[vert_first,IP2,IP3],N):-
...
focuspoint_slice2(bottomleft,[X,Y,X1,Y1],[W1,W2,H1,H2],[FP,CP1,CP2],[horiz,IP1],[horiz_first,IP2,IP3],N):-
	% writeln('bottomleft,horiz,horiz_first'),
	split([X,Y,W1,H1],[CP1,IP1],[IP2,IP3],N),
	slice([X1,Y,W2,H1],[IP3,CP2],N),
	slice([X,Y1,W1,H2],[FP,IP1,IP2],N).

focuspoint_slice2(_,_,_,_,_,_,_).
	% writeln('error, no case matched in focuspoint_slice2').
